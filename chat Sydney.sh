...
git clone https://github.com/renqabs/ChatSydney-react-img || (rm -rf ChatSydney-react-img && git clone https://github.com/xuyufenfei/ChatSydney-react-img) || show_error_and_exit "拉取失败"
